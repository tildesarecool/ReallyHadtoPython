# 2 march 2024
# from youtube video:
# https://www.youtube.com/watch?v=6oJMd6FWUB8
# went to github of demo:
# https://github.com/baraltech/Pomodoro-Timer-PyGame
# 
# I pasted this in as a demo for how a "timer" works in pygame
# normally i write it out and customize it but in this case I just 
# really wanted to see how that timer worked and hae a demonstration
# i think the main demonstration is from this line
# pygame.time.set_timer(pygame.USEREVENT, 1000)
# looks like an existing method
